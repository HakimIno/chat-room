...
config :example_phoenix, ExamplePhoenixWeb.Endpoint,
  ...
  secret_key_base: "YWrn/Sw5R3Tvgwe86JkE4ZBzCzcx+JQOi+02aB1R78LgbrHKn8T7lTaK3N45ex8K",
  server: false

# In test we don't send emails
config :example_phoenix, ExamplePhoenix.Mailer, adapter: Swoosh.Adapters.Test
